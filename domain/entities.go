...
type InvoiceEntity struct {
	...
	CreatedAt  time.Time              `gorm:"column:created_at" json:"created_at"`
	UpdatedAt  time.Time              `gorm:"column:updated_at" json:"updated_at"`
	Customer   *CustomerEntity        `gorm:"foreignKey:CustomerID" json:"customer,omitempty"`
	Details    *[]InvoiceDetailEntity `gorm:"foreignKey:InvoiceID" json:"details,omitempty"`
}
